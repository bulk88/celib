...
XCE_EXPORT int xcegettimeofday(struct timeval *tv, struct timezone *tz);
XCE_EXPORT int xcegettimeofday_timer(struct timeval *tv, struct timezone *tz);
